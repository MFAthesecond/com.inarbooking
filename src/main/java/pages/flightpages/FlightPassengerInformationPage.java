...
public class FlightPassengerInformationPage extends BasePage {
	...
	public void fillTravelerCard(int index, String firstName, String lastName, String gender, String year, String month,
			String day) {
		...
		WebElement genderSelect = travelerCard
			.findElement(By.xpath(".//select[@class='form-select fs-4 p-3 border-danger']"));
