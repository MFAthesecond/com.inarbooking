...
public class FlightConfirmationPage extends BasePage {
    ...
    public Map<String, String> getContainerInfo(String containerName) {
        ...
        containerInfo.put("takeoff time", getContainer(containerName).findElement(By.cssSelector("span[class=' fs-4 text-center']:nth-child(1)")).getText().split("\\n")[2]);
        ...
        containerInfo.put("arrival time", getContainer(containerName).findElement(By.cssSelector("span[class=' fs-4 text-center']:nth-child(3)")).getText().split("\\n")[2]);
