...
public class FlightExtrasPage extends BasePage {
	...
	public List<String> getFlightInfo() {
		List<WebElement> flightInfo = extrasContainer
	...
	public String getRouteInfo() {
		return extrasContainer.findElement(By.cssSelector("div[class='col-12 display-2 fw-semibold text-dark']"))
			.getText();
	}
	...
	public void selectExtra(String extraName) {
		WebElement extra = extrasCheckBoxList.stream()
			.filter(element -> element.findElement(By.cssSelector("label")).getText().contains(extraName))
			.findFirst()
			.get();
	...
	public String getTicketPrice() {
		return priceCalculationContainer.findElement(By.cssSelector(".mb-3:nth-child(1) > div > span:nth-child(1)"))
			.getText()
			.substring(2);
	}

	public String getTaxesAndFeesPercentage() {
		String taxesAndFees = priceCalculationContainer
			.findElement(By.cssSelector(".mb-3:nth-child(2)  > span:nth-child(1)"))
			.getText();
	...
	public String getThirdPartyFeePercentage() {
		String thirdPartyFee = priceCalculationContainer
			.findElement(By.cssSelector(".mb-3:nth-child(3)  > span:nth-child(1)"))
			.getText();
	...
	public String getTotalPrice() {
		String[] dividedPrice = priceCalculationContainer.findElement(By.cssSelector("h1:nth-child(2)"))
			.getText()
			.split("\\$");
	...
	public Double getCalculatedTotalPrice() {
		...
		double totalPrice = ticketPrice + ((ticketPrice * taxesAndFeesPercentage) / 100)
				+ ((ticketPrice * thirdPartyFeePercentage) / 100);
