...
public class CarRentalCheckoutPageSteps extends BaseStep {
	...
	public void verifyThatNumberOfTextDangerMessageIs(String expectedNumberOfDangerMessage) {
		...
		logInfo("Verifying the number of text danger messages: Expected - " + expectedNumberOfDangerMessage
				+ ", Actual - " + actualNumberOfDangerMessage);
		logDebug("Debug - Verifying the number of text danger messages: Expected - " + expectedNumberOfDangerMessage
				+ ", Actual - " + actualNumberOfDangerMessage);
