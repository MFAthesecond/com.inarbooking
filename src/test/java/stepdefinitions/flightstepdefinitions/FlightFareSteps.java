...
public class FlightFareSteps extends BaseStep {
    ...
    public void verifyThatTheDepartureRouteAndTheReturnRoute(String departureRoute, String returnRoute) {
        try {
            ...
            then(PAGES.getFlightPages().getFlightFarePage().getContainerDirection("return"))
                    .as("Return route check")
    ...
    public void verifyThatTheIsSelectedForDepartureFareTypeAndIsSelectedForReturnFareType(String departureFareType, String returnFareType) {
        try {
            LOGGER.debug("Verifying departure fare type: {} and return fare type: {} are selected.", departureFareType, returnFareType);
    ...
    public void getDepartureRouteInformationAndClickOnForDepartureFareType(String fareType) {
        try {
            ...
            LOGGER.error("Error occurred while getting departure route information and clicking on {} for departure fare type.", fareType, e);
            throw e;
        }
    ...
    public void getReturnRouteInformationAndClickOnForReturnFareType(String fareType) {
        try {
            ...
            LOGGER.error("Error occurred while getting return route information and clicking on {} for return fare type.", fareType, e);
            throw e;
        }
    }
}
