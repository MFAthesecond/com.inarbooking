...
public class FlightSelectionSteps extends BaseStep {
	...
	public void verifyThatForOriginForDestinationForAdultForChildrenDropdown(String originName, String destinationName,
		...
		then(PAGES.getFlightPages()
			...
			.isElementOnDropDownSelected(destinationName, "Destination")).isTrue();
		then(PAGES.getFlightPages().getFlightSelectionPage().isElementOnDropDownSelected(adultNum, "AdultForRoundTrip"))
			.isTrue();
		then(PAGES.getFlightPages()
			.getFlightSelectionPage()
			.isElementOnDropDownSelected(childrenNum, "ChildrenForRoundTrip")).isTrue();
	}
	...
	public void verifyThatAndUnselectedForForCabinClassSelectedForAirlinesSelectedForDuration(String cabinClassName1,
		...
		then(PAGES.getFlightPages()
			.getFlightSelectionPage()
			.isElementSelectedOnList(cabinClassName1, "CabinClassForRoundTrip")).isFalse();
		then(PAGES.getFlightPages()
			.getFlightSelectionPage()
			.isElementSelectedOnList(cabinClassName2, "CabinClassForRoundTrip")).isFalse();
		then(PAGES.getFlightPages()
			.getFlightSelectionPage()
			.isElementSelectedOnList(airlineName, "AirlinesForRoundTrip")).isTrue();
